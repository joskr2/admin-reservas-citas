...
export default function CitaModal({
	...
	const handleCambiarEstado = async (
		nuevoEstado: "en_progreso" | "terminada",
	) => {
		setIsUpdating(true);
		try {
	...
	const getEstadoColor = (estado: string) => {
		switch (estado) {
			case "pendiente":
				return "bg-gradient-to-r from-yellow-100 to-amber-100 text-yellow-800 border-yellow-200 dark:from-yellow-900/20 dark:to-amber-900/20 dark:text-yellow-400 dark:border-yellow-800";
			case "en_progreso":
				return "bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-800 border-blue-200 dark:from-blue-900/20 dark:to-indigo-900/20 dark:text-blue-400 dark:border-blue-800";
			case "terminada":
				return "bg-gradient-to-r from-green-100 to-emerald-100 text-green-800 border-green-200 dark:from-green-900/20 dark:to-emerald-900/20 dark:text-green-400 dark:border-green-800";
			default:
	...
	return (
		<Dialog open={isOpen} onOpenChange={onClose}>
			<DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto bg-gradient-to-br from-blue-50/50 to-purple-50/50 dark:from-blue-950/50 dark:to-purple-950/50 backdrop-blur-xl border-0 shadow-2xl">
				<DialogHeader className="space-y-4">
					...
					<div
						className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold border ${getEstadoColor(cita.estado)}`}
					>
				...
				<div className="space-y-6">
					...
					<Card className="shadow-lg border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
						...
						<CardContent className="space-y-3">
							<div className="flex items-center gap-3 p-3 bg-gray-50/80 dark:bg-gray-700/50 rounded-lg">
					...
					{esPsicologo && cita.estado !== "terminada" && (
						<Card className="shadow-lg border-0 bg-gradient-to-r from-blue-50/80 to-purple-50/80 dark:from-blue-950/50 dark:to-purple-950/50 backdrop-blur-sm">
							<CardHeader className="pb-3">
